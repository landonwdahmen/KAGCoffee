...
class GenDiscPage extends StatelessWidget {
  const GenDiscPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('General Discussions'),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text(
                'This is for general discussions.',
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  // Your like button code here (if any)
